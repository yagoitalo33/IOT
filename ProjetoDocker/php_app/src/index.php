            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="create.php" class="btn btn-success pull-right">Adicionar novos empregados</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if($result = mysqli_query($link, $sql)){
                        ...
                        echo "ERRO: N&atilde;o foi poss&iacute;vel executar $sql. " . mysqli_error($link);
                    }
